...
float       g_OllamaTemperature = 0.5f;
float       g_OllamaTopP = 0.85f;
...
void LoadOllamaChatConfig()
{
    ...
    g_OllamaTemperature               = sConfigMgr->GetOption<float>("OllamaChat.Temperature", 0.5f);
    g_OllamaTopP                      = sConfigMgr->GetOption<float>("OllamaChat.TopP", 0.85f);

...
inline constexpr uint32_t FactsMaxChars = 300;
inline constexpr uint32_t NotesMaxChars = 200;
inline constexpr uint32_t CompactionThreshold = 6;
inline constexpr uint32_t CompactionMaxAgeMinutes = 60;
inline constexpr uint32_t EpisodicMaxAgeDays = 30;
inline constexpr uint32_t RecallMaxItems = 3;
inline constexpr uint32_t SessionResumeMinutes = 30;
...
inline constexpr uint32_t MaintenanceCooldownSec = 300;
...
inline constexpr uint32_t DeferQueueThreshold = 2;
inline constexpr uint32_t PairCacheMax = 500;
inline constexpr uint32_t PairCacheIdleSec = 86400;
inline constexpr uint32_t ArchiveRingCap = 30;
}
